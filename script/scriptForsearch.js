$(function () {
  ...
  fetch("https://anjungme.github.io/project_cineflex/json/goods.json")
    ...
    .then((json) => {
      ...
      for (let i = 0; k > i; i++) {
        ...
        $(".recomendeds").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
  ...
  $("#searchInput").on("keydown", function (event) {
    ...
    if (event.key === "Enter") {
      ...
      fetch("./json/goods.json")
        ...
        .then((json) => {
          let { movies } = json;
          let searchList = movies.filter((movie) => movie.title.includes(inputValueViod));
          console.log(searchList);
          $("#searchList").append(`<span class="sub_name">검색하신  "${inputValue}"을(를) 포함한 </span>`);
          for (var i = 0; searchList.length > i; i++) {
            ...
            var checkfinal = CheckClass(title);
            var checkTexts = CheckText(checkfinal);
            $("#searchList").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
              <button class="modal_button" value="${title}">i</button>                
              <button class=${checkfinal} value="${title}">${checkTexts}</button>
              <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
              <span class="movie_title">${title}</span>
        ...
        fetch("./json/goods.json")
          ...
          .then((json) => {
            ...
            for (var i = 0; showTen > i; i++) {
              ...
              var checkfinal = CheckClass(title);
              var checkTexts = CheckText(checkfinal);
              $("#movieSection").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
                <button class="modal_button" value="${title}">i</button>                
                <button class=${checkfinal} value="${title}">${checkTexts}</button>
                <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
                <span class="movie_title">${title}</span>
        ...
        fetch("./json/goods.json")
          ...
          .then((json) => {
            ...
            for (var i = 0; showTen > i; i++) {
              ...
              var checkfinal = CheckClass(title);
              var checkTexts = CheckText(checkfinal);
              $("#aniSection").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
                <button class="modal_button" value="${title}">i</button>                
                <button class=${checkfinal} value="${title}">${checkTexts}</button>
                <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
                <span class="movie_title">${title}</span>
        ...
        fetch("./json/goods.json")
          ...
          .then((json) => {
            ...
            for (var i = 0; showTen > i; i++) {
              ...
              var checkfinal = CheckClass(title);
              var checkTexts = CheckText(checkfinal);
              $("#entertainmentSection").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
                <button class="modal_button" value="${title}">i</button>                
                <button class=${checkfinal} value="${title}">${checkTexts}</button>
                <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
                <span class="movie_title">${title}</span>
  ...
  // $(".pickList").on("click keypress", function () {
  //   $(this).prevAll().css("backgroundColor", "#666");
  //   $(this).nextAll().css("backgroundColor", "#666");
  //   $(this).css("backgroundColor", "#8b0000");
  ...
  //   if (title === "movie") {
  //     movieShowed = 0;
  //     $("#movieSection").empty(); // 기존 내용을 지웁니다.
  ...
  //           var checkfinal = CheckClass(title);
  //           var checkTexts = CheckText(checkfinal);
  //           $("#movieSection").append(`<div class="recomended">
  //             <div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
  //               <button class="modal_button" value="${title}">i</button>
  //               <button class=${checkfinal} value="${title}">${checkTexts}</button>
  //               <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
  //               <span class="movie_title">${title}</span>
  ...
  //           var checkfinal = CheckClass(title);
  //           var checkTexts = CheckText(checkfinal);
  //           $("#aniSection").append(`<div class="recomended">
  //             <div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
  //               <button class="modal_button" value="${title}">i</button>
  //               <button class=${checkfinal} value="${title}">${checkTexts}</button>
  //               <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
  ...
  if (isMovieButtonClicked == "movie") {
    ...
    $(".pickList[title='movie']").children("a").css("backgroundColor", "#8b0000");
    $(".pickList").children("a").removeClass("picked");
    ...
    $(".pickList").children("a").css("backgroundColor", "#666");
    $(".pickList[title='entertainment']").children("a").css("backgroundColor", "#8b0000");
    $(".pickList").children("a").removeClass("picked");
    ...
    $(".pickList").children("a").css("backgroundColor", "#666");
    $(".pickList[title='drama']").children("a").css("backgroundColor", "#8b0000");
    $(".pickList").children("a").removeClass("picked");
    ...
    fetch("./json/goods.json")
      ...
      .then((json) => {
        ...
        for (var i = 0; dramaShowed > i; i++) {
          ...
          var checkfinal = CheckClass(title);
          var checkTexts = CheckText(checkfinal);
          $("#dramaSection").append(`<div class="recomended"><div class="recomended_imgbox"><img src=${src} alt="${title}"></div>
            <button class="modal_button" value="${title}">i</button>                
            <button class=${checkfinal} value="${title}">${checkTexts}</button>
            <span class="movie_grade ${movieGradeClass}">${age_grade}</span>
            <span class="movie_title">${title}</span>
